...
class EventItem(scrapy.Item):
    """Item per gli eventi di Artribune (compatibile con schema DB comune)"""
    ...
    image_url = scrapy.Field()  # Immagine principale
    image_urls = scrapy.Field() # Array di tutte le immagini trovate
    city = scrapy.Field()  # Città dell'evento
    ...
    event_info = scrapy.Field() # Info strutturate dal box "Informazioni Evento"
