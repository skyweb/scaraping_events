...
from .serializers import (
    ...
    ComuniItalianiRawDataSerializer,
)
...
class IngestionView(APIView):
    ...
    @extend_schema(
        ...
        responses={201: ComuniItalianiRawDataSerializer},
        summary="Ingestione singolo record",
    )
    def post(self, request):
        ...
        return Response(
            ComuniItalianiRawDataSerializer(instance).data,
...
class BulkIngestionView(APIView):
    ...
    @extend_schema(
        ...
        responses={201: dict},
        summary="Ingestione bulk record",
    )
    def post(self, request):
        ...
        created = ComuniItalianiRawData.objects.bulk_create(objects_to_create)
