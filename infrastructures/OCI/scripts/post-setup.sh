...
echo "  ansible-playbook ansible/playbooks/domain-setup.yml --ask-vault-pass     # HTTPS sottodomini (IngressRoute)"
echo "  ansible-playbook ansible/playbooks/reverse-proxy-setup.yml --ask-vault-pass  # TCP forwarding (micro-gw)"
echo ""
echo "Oppure tutti in sequenza:"
